-- Veranstaltungen (Rallye-Events): Zeitplan & WP-Plan.
-- Anders als die cloud_*-JSONB-Tabellen (die den lokalen IndexedDB-Store
-- spiegeln) sind dies "echte" relationale Tabellen mit Server-seitig
-- generierten UUIDs und Fremdschlüsseln – Veranstaltungen werden direkt
-- gegen Supabase gelesen/geschrieben (kein Offline-First/Tombstone-Sync
-- wie bei Fahrzeugen/Sessions), daher kein "id text"-Client-ID-Muster.
